...
// // Upsert vector data into the specified index in batches
...
//       // Delay added to prevent hitting Pinecone's rate limits
...
//     console.log(
//       `Finished upserting ${vectors.length} vectors into "${indexName}".`
//     );
//   } catch (error: any) {
//     console.error(`Error upserting vectors to "${indexName}":`, error.message);
//     throw error;
//   }
// }

// // Query the index using a vector and return top matches
